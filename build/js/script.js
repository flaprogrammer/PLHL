...
Mygallery = (function() {
  function Mygallery(opts) {
    ...
    $(opts.prevBut).on('click', (function(_this) {
      return function() {
        return _this.goToSlide('prev');
      };
    })(this));
    $(opts.nextBut).on('click', (function(_this) {
      return function() {
        return _this.goToSlide('next');
      };
    })(this));
  }
